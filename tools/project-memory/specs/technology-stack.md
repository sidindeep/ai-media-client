...
| Web runtime | Node >=22.9, встроенные HTTP/fetch/SSE; проверено 24.14.1 | web-tg/server.js, web-tg/src/server/, web-tg/public/ |
...
| Секреты web/bot | Server environment, .env вне Git | web-tg/.env.example, web-tg/src/server/config.js |

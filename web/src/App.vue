...
const promptSuggestions = computed(() => ({
  text: [
    [t('suggestions.text.publish.label'), t('suggestions.text.publish.prompt')],
    [t('suggestions.text.improvePrompt.label'), t('suggestions.text.improvePrompt.prompt')],
    [t('suggestions.text.concepts.label'), t('suggestions.text.concepts.prompt')],
    [t('suggestions.text.edit.label'), t('suggestions.text.edit.prompt')],
    [t('suggestions.text.videoScript.label'), t('suggestions.text.videoScript.prompt')],
    [t('suggestions.text.projectStructure.label'), t('suggestions.text.projectStructure.prompt')],
  ],
  image: [
    [t('suggestions.image.portrait.label'), t('suggestions.image.portrait.prompt')],
    [t('suggestions.image.logo.label'), t('suggestions.image.logo.prompt')],
    [t('suggestions.image.anime.label'), t('suggestions.image.anime.prompt')],
    [t('suggestions.image.social.label'), t('suggestions.image.social.prompt')],
    [t('suggestions.image.cyberpunk.label'), t('suggestions.image.cyberpunk.prompt')],
    [t('suggestions.image.illustration.label'), t('suggestions.image.illustration.prompt')],
  ],
  video: [
    [t('suggestions.video.scene.label'), t('suggestions.video.scene.prompt')],
    [t('suggestions.video.productAd.label'), t('suggestions.video.productAd.prompt')],
    [t('suggestions.video.animateImage.label'), t('suggestions.video.animateImage.prompt')],
    [t('suggestions.video.social.label'), t('suggestions.video.social.prompt')],
    [t('suggestions.video.cameraFlythrough.label'), t('suggestions.video.cameraFlythrough.prompt')],
    [t('suggestions.video.atmospheric.label'), t('suggestions.video.atmospheric.prompt')],
  ],
  audio: [
    [t('suggestions.audio.voiceover.label'), t('suggestions.audio.voiceover.prompt')],
    [t('suggestions.audio.music.label'), t('suggestions.audio.music.prompt')],
    [t('suggestions.audio.ambience.label'), t('suggestions.audio.ambience.prompt')],
    [t('suggestions.audio.brandJingle.label'), t('suggestions.audio.brandJingle.prompt')],
    [t('suggestions.audio.videoSound.label'), t('suggestions.audio.videoSound.prompt')],
    [t('suggestions.audio.calmBackground.label'), t('suggestions.audio.calmBackground.prompt')],
  ],
}[studio.mode]));
